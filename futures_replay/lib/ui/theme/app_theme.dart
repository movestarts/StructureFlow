...
class AppColors {
  ...
  static const Color lightCardHover = Color(0xFFF0F4FF);
  static const Color lightSurface = Color(0xFFF8F9FC);
  static const Color lightBorder = Color(0xFFE8ECF1);
  static const Color lightDivider = Color(0xFFEEF0F4);
  ...
  // 训练卡片 header 色
  static const Color spotHeaderBg = Color(0xFFECFDF5);
  static const Color futuresHeaderBg = Color(0xFFEFF6FF);
}
