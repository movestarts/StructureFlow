...
const KlineEntitySchema = CollectionSchema(
  ...
  idName: r'id',
  indexes: {
    r'symbol_time_period': IndexSchema(
      id: 2164661139277753516,
      name: r'symbol_time_period',
      unique: false,
      replace: false,
      properties: [
        IndexPropertySchema(
...
KlineEntity _klineEntityDeserialize(
  ...
  object.volume = reader.readDouble(offsets[7]);
  return object;
}
...
extension KlineEntityQueryWhereSort
  ...
  QueryBuilder<KlineEntity, KlineEntity, QAfterWhere> anyTime() {
    return QueryBuilder.apply(this, (query) {
...
extension KlineEntityQueryWhere
  ...
  QueryBuilder<KlineEntity, KlineEntity, QAfterWhereClause>
      symbolEqualToAnyTimePeriod(String symbol) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'symbol_time_period',
        value: [symbol],
      ));
    });
  }
  ...
  QueryBuilder<KlineEntity, KlineEntity, QAfterWhereClause>
      symbolNotEqualToAnyTimePeriod(String symbol) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<KlineEntity, KlineEntity, QAfterWhereClause>
      symbolTimeEqualToAnyPeriod(String symbol, int time) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'symbol_time_period',
        value: [symbol, time],
  ...
  QueryBuilder<KlineEntity, KlineEntity, QAfterWhereClause>
      symbolEqualToTimeNotEqualToAnyPeriod(String symbol, int time) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(IndexWhereClause.between(
  ...
  QueryBuilder<KlineEntity, KlineEntity, QAfterWhereClause>
      symbolEqualToTimeGreaterThanAnyPeriod(
    String symbol,
    int time, {
    bool include = false,
  }) {
  ...
  QueryBuilder<KlineEntity, KlineEntity, QAfterWhereClause>
      symbolEqualToTimeLessThanAnyPeriod(
    String symbol,
    int time, {
    bool include = false,
  }) {
  ...
  QueryBuilder<KlineEntity, KlineEntity, QAfterWhereClause>
      symbolEqualToTimeBetweenAnyPeriod(
    String symbol,
    int lowerTime,
    int upperTime, {
    bool includeLower = true,
    ...
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'symbol_time_period',
        lower: [symbol, lowerTime],
        includeLower: includeLower,
        upper: [symbol, upperTime],
        includeUpper: includeUpper,
      ));
    });
  }
  ...
  QueryBuilder<KlineEntity, KlineEntity, QAfterWhereClause>
      symbolTimePeriodEqualTo(String symbol, int time, String period) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'symbol_time_period',
        value: [symbol, time, period],
      ));
    });
  }

  QueryBuilder<KlineEntity, KlineEntity, QAfterWhereClause>
      symbolTimeEqualToPeriodNotEqualTo(
          String symbol, int time, String period) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(IndexWhereClause.between(
              indexName: r'symbol_time_period',
              lower: [symbol, time],
              upper: [symbol, time, period],
              includeUpper: false,
            ))
            .addWhereClause(IndexWhereClause.between(
              indexName: r'symbol_time_period',
              lower: [symbol, time, period],
              includeLower: false,
              upper: [symbol, time],
            ));
      } else {
  ...
  QueryBuilder<KlineEntity, KlineEntity, QAfterWhereClause> timeEqualTo(
      int time) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'time',
  ...
  QueryBuilder<KlineEntity, KlineEntity, QAfterWhereClause> timeNotEqualTo(
      int time) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<KlineEntity, KlineEntity, QAfterWhereClause> timeGreaterThan(
    int time, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<KlineEntity, KlineEntity, QAfterWhereClause> timeLessThan(
    int time, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<KlineEntity, KlineEntity, QAfterWhereClause> timeBetween(
    int lowerTime,
    int upperTime, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension KlineEntityQueryFilter
  ...
  QueryBuilder<KlineEntity, KlineEntity, QAfterFilterCondition> periodEqualTo(
    String value, {
  ...
  QueryBuilder<KlineEntity, KlineEntity, QAfterFilterCondition> periodLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<KlineEntity, KlineEntity, QAfterFilterCondition> periodBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<KlineEntity, KlineEntity, QAfterFilterCondition> periodEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<KlineEntity, KlineEntity, QAfterFilterCondition> periodContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<KlineEntity, KlineEntity, QAfterFilterCondition> periodMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<KlineEntity, KlineEntity, QAfterFilterCondition> volumeEqualTo(
    double value, {
    double epsilon = Query.epsilon,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<KlineEntity, KlineEntity, QAfterFilterCondition> volumeLessThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<KlineEntity, KlineEntity, QAfterFilterCondition> volumeBetween(
    double lower,
    double upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension KlineEntityQuerySortBy
  ...
  QueryBuilder<KlineEntity, KlineEntity, QAfterSortBy> sortByPeriod() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'period', Sort.asc);
    });
  }

  QueryBuilder<KlineEntity, KlineEntity, QAfterSortBy> sortByPeriodDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<KlineEntity, KlineEntity, QAfterSortBy> sortByVolume() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'volume', Sort.asc);
    });
  }

  QueryBuilder<KlineEntity, KlineEntity, QAfterSortBy> sortByVolumeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension KlineEntityQuerySortThenBy
  ...
  QueryBuilder<KlineEntity, KlineEntity, QAfterSortBy> thenByPeriod() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'period', Sort.asc);
    });
  }

  QueryBuilder<KlineEntity, KlineEntity, QAfterSortBy> thenByPeriodDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'period', Sort.desc);
    });
  }
  ...
  QueryBuilder<KlineEntity, KlineEntity, QAfterSortBy> thenByVolume() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'volume', Sort.asc);
    });
  }

  QueryBuilder<KlineEntity, KlineEntity, QAfterSortBy> thenByVolumeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'volume', Sort.desc);
    });
  }
...
extension KlineEntityQueryWhereDistinct
  ...
  QueryBuilder<KlineEntity, KlineEntity, QDistinct> distinctByPeriod(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<KlineEntity, KlineEntity, QDistinct> distinctByVolume() {
    return QueryBuilder.apply(this, (query) {
...
extension KlineEntityQueryProperty
  ...
  QueryBuilder<KlineEntity, String, QQueryOperations> periodProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<KlineEntity, double, QQueryOperations> volumeProperty() {
    return QueryBuilder.apply(this, (query) {
